...
function View({ view, project, projects, status, items, articles, topics, materials, distributions, busy, setView, openContent, contentTab, openPlatform, edit, switchProject, refresh, workBuddy, setWorkBuddy, update, setUpdate, connect, notify }: any) {
  ...
  if (view === 'content') return <ContentCenter project={project} items={items} materials={materials} topics={topics} articles={articles} busy={busy} refresh={refresh} notify={notify} initialTab={contentTab}/>;
...
function ContentCenter({ project, items, materials, topics, articles, busy, refresh, notify, initialTab = 'overview' }: any) {
